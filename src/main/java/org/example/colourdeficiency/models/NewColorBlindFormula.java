...
public class NewColorBlindFormula {
    ...
    private static double[] getBrettelParams(String type, double[] rgb) {
        switch (type) {
            case "protan":
                return rgb[0] * 0.00048 + rgb[1] * 0.00416 + rgb[2] * -0.00464 >= 0 ?
            ...
            case "deutan":
                return rgb[0] * -0.00293 + rgb[1] * -0.00645 + rgb[2] * 0.00938 >= 0 ?
            ...
            case "tritan":
                return rgb[0] * 0.03960 + rgb[1] * -0.02831 + rgb[2] * -0.01129 >= 0 ?
